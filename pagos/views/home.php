...
<div class="layout-split">
    ...
    <section class="panel panel--form" id="nuevo">
        ...
        <form class="form" method="post" action="<?= e(url('/prestamos/crear')) ?>" id="form-prestamo" novalidate>
    ...
    <section class="panel panel--list">
        ...
        <?php else: ?>
            <div class="loan-list">
                ...
                ?>
                    <a class="loan-card <?= $liquidado ? 'loan-card--done' : '' ?>" href="<?= e(url('/prestamo/' . (int) $p['id'])) ?>">
