    ...
    <div class="layout-split">
        ...
        <section class="panel panel--form">
            ...
            <form class="form" id="form-pago"
                  method="post" action="<?= e(url('/pagos/crear')) ?>"
            ...
            <div class="danger-form">
                <a href="<?= e(url('/prestamo/' . (int) $prestamo['id'] . '/editar')) ?>" class="btn-outline btn-outline--full">✏ Editar préstamo</a>
                <form method="post" action="<?= e(url('/prestamo/' . (int) $prestamo['id'] . '/eliminar')) ?>"
                      onsubmit="return confirm('¿Eliminar este préstamo y todos sus abonos? Esta acción no se puede deshacer.');">
                    <input type="hidden" name="csrf" value="<?= e(csrf_token()) ?>">
                    ...
                    <?php foreach ($pagos as $pago): ?>
                        <div class="pago">
                            ...
                            <div class="pago__side">
                                ...
                                <form method="post" action="<?= e(url('/pagos/' . (int) $pago['id'] . '/eliminar')) ?>"
